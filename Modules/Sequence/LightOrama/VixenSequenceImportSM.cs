...
{
	public class LightOramaSequenceImportSM
	{
		...
		/// </summary>
		private ILightOramaImportStateMachine m_stateMachine = null;
		...
		// public accessors
		public ILightOramaImportStateMachine StateMachine { get { return m_stateMachine; } set { m_stateMachine = value; } }
		...
		/// </summary>
		public LightOramaSequenceImportSM(ISequence sequence, double eventDuration)
		{
			Logging.Debug("LightOramaSequenceImport - Enter");
			...
			Logging.Debug("LightOramaSequenceImport - Exit");
		} // LightOramaSequenceImport
		...
		{
			Logging.Debug("LightOramaSequenceImport::OpenChannel - Enter. GUID '" + TargetChannelId.ToString() + "' eventDuration: " + eventDuration);

			// set the target node for the incoming data
			if (null == (m_targetNode = VixenSystem.Nodes.GetElementNode(TargetChannelId)))
			{
				Logging.Error("LightOramaSequenceImport::OpenChannel - GUID '" + TargetChannelId.ToString() + "' eventDuration: " + eventDuration);
				StateMachine = m_IgnoreEvents;
			}
			else
			{
			...
			Logging.Debug("LightOramaSequenceImport::OpenChannel - Exit");
		} // OpenChannel
		...
		{
			//			Logging.Info("LightOramaSequenceImport::processEvent - Enter. position: " + position + ", color: " + color.ToString() + ", intensity: " + intensity);
			m_stateMachine.processEvent(this, position, color, intensity);
			//			Logging.Info("LightOramaSequenceImport::processEvent - Exit");
		}
		...
		{
			Logging.Debug("LightOramaSequenceImport::closeChannel - Entry");
			m_stateMachine.closeChannel(this);
			Logging.Debug("LightOramaSequenceImport::closeChannel - Exit");
		} // closeChannel
		...
		public EffectNode GenerateSetLevelEffect(uint intensity,
												 ...
												 Color v3color)
		{
			//			Logging.Info("LightOramaSequenceImport::GenerateSetLevelEffect - Entry");
			...
			//			Logging.Info("LightOramaSequenceImport::GenerateSetLevelEffect - Exit");
			return effectNode;
	...
	} // end class LightOramaImportStateMachine

	/// <summary>
	/// Interface class for the state machine
	/// </summary>
	public interface ILightOramaImportStateMachine
	{
		void processEvent(LightOramaSequenceImportSM parent, uint position, Color color, byte intensity);
		void closeChannel(LightOramaSequenceImportSM parent);
	} // LightOramaSequenceImport

	/// <summary>
	/// State to ignore the incoming events
	/// </summary>
	public class SIgnoreEvents : ILightOramaImportStateMachine
	{
		public void processEvent(LightOramaSequenceImportSM parent, uint position, Color color, byte intensity)
		{
			// just ignore the data
		} // processEvent

		public void closeChannel(LightOramaSequenceImportSM parent)
		{
	...
	/// </summary>
	public class SWaitingToStart : ILightOramaImportStateMachine
	{
		private static NLog.Logger Logging = NLog.LogManager.GetCurrentClassLogger();
		public void processEvent(LightOramaSequenceImportSM parent, uint position, Color color, byte intensity)
		{
...
//			Logging.Info("SWaitingToStart::processEvent - Exit");
	...
	/// </summary>
	public class SHoldingOneEvent : ILightOramaImportStateMachine
	{
		public void processEvent(LightOramaSequenceImportSM parent, uint position, Color color, byte intensity)
		{
	...
	/// </summary>
	public class SSingleIntensityMultipleEvents : ILightOramaImportStateMachine
	{
		public void processEvent(LightOramaSequenceImportSM parent, uint position, Color color, byte intensity)
		{
			// is the intensity and color the same as it was?
	...
	/// </summary>
	public class SRampDown : ILightOramaImportStateMachine
	{
		public void processEvent(LightOramaSequenceImportSM parent, uint position, Color color, byte intensity)
		{
			// is the intensity and color the same as it was?
	...
	/// </summary>
	public class SRampUp : ILightOramaImportStateMachine
	{
		public void processEvent(LightOramaSequenceImportSM parent, uint position, Color color, byte intensity)
		{
			// is the intensity and color the same as it was?
